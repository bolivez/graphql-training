    ...
    return {
        ...
        async handler(args) {
            ...
            const successMessages = [
                ...
                context.type,
                'Next Steps:',
                `- Change directory to the project folder - ${chalk_1.default.cyan(`cd ${context.type}`)}`,
...
function askForInitializationType(projectType) {
    return common_2.askForEnum({
        ...
        ignoreList: projectType === common_2.ProjectType.FrontendOnly ? [common_2.InitializationType.ExistingOpenAPI] : [],
    });
}
